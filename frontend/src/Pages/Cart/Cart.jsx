...
const Cart = () => {
    ...
    const mrp = cartData.reduce(function (sum, item, index, arr) {
        return sum + Number(item.price);
      }, 0);
    console.log(mrp)
    const disc = cartData.reduce(function (sum, item, index, arr) {
        ...
        <div className={styles.price_main}>
            ...
            <div className={styles.price_calc}>
                <div className={styles.mrp_div}>
                    <div>Total MRP</div>
                    <div className={styles.mrp_dy}>₹{mrp}</div>
                </div>
                <div className={styles.discount_div}>
                    <div>Offer discount</div>
                    <div className={styles.green}>- ₹{disc}</div>
                </div>
                ...
                <div className={styles.out_button}>
                    <button ><Link className={styles.btn_check} to="/checkout">Checkout now</Link></button>
                </div>
